...
function getRandomFlavors(array1,array2,array3,array4){
    let returnArray = [];
    array1 = array1.concat(array2).concat(array3).concat(array4)
    for (let i = 1; i <= 31; i++){
        let rand = Math.floor(Math.random()*array1.length + 1) - 1;
        returnArray.push(array1[rand]);
        array1.splice(rand,1);
    }
    return returnArray;
}
